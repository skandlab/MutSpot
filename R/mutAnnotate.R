...
mutAnnotate = function(hotspots.file, cds.file = system.file("extdata", "Ensembl75.CDS.bed", package = "MutSpot"), 
                       ...
                       intron.file = system.file("extdata", "Ensembl75.intron.bed", package = "MutSpot"),
